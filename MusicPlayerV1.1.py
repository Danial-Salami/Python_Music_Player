...
class MusicPlayerGUI:
    def __init__(self, root):
        ...
        next_btn = tk.Button(bottom_frame, text="Next", command=self.next_song, width=10, height=1,
                             font=("Arial", 16, "bold"), fg=self.secondary_color, bg=self.button_color)
        next_btn.pack(side=tk.LEFT, padx=5, pady=5)

        previous_btn = tk.Button(bottom_frame, text="Previous", command=self.previous_song, width=10, height=1,
                                 font=("Arial", 16, "bold"), fg=self.secondary_color, bg=self.button_color)
        previous_btn.pack(side=tk.LEFT, padx=5, pady=5)
        ...
        volume_label.grid(row=0, column=7, padx=5, pady=5)
        ...
        self.volume_slider.grid(row=0, column=8, padx=5, pady=5)
